...
var (
	...
	paramsPr = flag.String("params", `{"in_dir":"in_dir","urls":[],"cmd":"ffmpeg.exe","args":["-i","{input}","-c:v","libx264","-b:v","500k","-c:a","copy","{output}"],"out_ext":"mp4","ftp":{"addr":"addr","login":"login","pass":"pass"}}`, "Параметры для вызова сервиса")
